// Daftar List Kodam Dapetnya disini Kids
// https://github.com/andixax/khodam-cek
function khodamName(){
    let khodamList =[
        "Martabak Cokelat",
        "Naga Sakti",
        ...
        "Star Platinum",
        "Gajah"
        // Tambah Khodam yang kalian Inginkan
    ]
    
    let result = document.getElementById("result")
    let khodamnum = Math.floor(Math.random() * khodamList.length);
    ...
    if (nama.trim() === '') {
        ...
        result.textContent = nama + ", " + "Khodam kamu : " + khodamList[khodamnum]
        clearInput()
    }
